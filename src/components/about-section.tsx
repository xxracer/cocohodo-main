...
import { Coffee, BookOpen, Heart, Users, Gift } from "lucide-react";
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Cocohodo is more than a place for coffee. We&rsquo;re a caf&eacute; built around variety, comfort, and community,
                from sweet desserts and savory crepes to sandwiches, ice cream, and specialty coffee drinks.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                Whether you&rsquo;re here for a business meeting, a study session, a family outing, or a quick bite with the kids,
                Cocohodo is a welcoming place for every kind of customer and every kind of craving.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                With sweet, savory, and specialty caf&eacute; favorites all in one place, Cocohodo brings people together
                over good food, good drinks, and a relaxed community vibe.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                A lot of people don&rsquo;t realize there&rsquo;s a full food menu here &mdash; from hearty breakfast crepes
                and savory sandwiches to viral Dubai Chocolate desserts, there&rsquo;s truly something for everyone.
              </p>
            </div>

            {/* Rewards Program */}
            <div className="pt-6">
              <div className="relative group p-6 rounded-2xl bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 border border-primary/20 backdrop-blur-sm transition-all duration-300 hover:shadow-lg hover:border-accent/30">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ask in-store about our rewards program and membership perks &mdash; earn points on every coffee, crepe, and dessert.
                    </p>
                  </div>
                </div>
              </div>
